      ...
      <div class="st-content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
            	<form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST"  action="<?php echo base_url() ?>kelas/insert">
                    ...
                    <div class="form-group margin-none">
                        <div class="col-sm-offset-3 col-sm-9">
                    	    <button id="submit" type="submit" name="submit" value="Tambah Class" class="btn btn-primary">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
