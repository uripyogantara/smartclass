...
<style type="text/css">
	...
	.pull-right.dropdown > a.toggle-button {
	    color: #e0e0e0;
	    padding: 10px;
	}

	.pull-right.dropdown.open > a.toggle-button {
	    color: #616161;
	}
</style>
			...
			<li class="media media-clearfix-xs">
                <div class="media-left">
					<div class="user-wrapper">
						<div style="margin-top: 15px;"><a href="<?php echo base_url("kelas/view/$value[class_nickname]") ?>"><?php echo "$value[class_name]"; ?></a></div>
			...
			$.ajax({
				...
				success: function(response){
					if (response.success) {
						...
						showPost();
						swal("Congratulation", "Task Successfull Uploaded", "success");
					}else{
						alert('error');
					}
				},
			...
			$.ajax({
				...
				success: function(response){
					if (response.success) {
						...
						showPost();
						swal("Congratulation", "Task Successfull Reuploaded", "success");
					}else{
						alert('error');
					}
				},
